...
async function loadStats() {
  try {
    ...
    document.getElementById("statNode").textContent = d.node_version;
    document.getElementById("statCores").textContent = d.cpu_cores;
    document.getElementById("statArch").textContent = d.arch;
    document.getElementById("statMem").textContent = `${d.memory_used_mb} MB / ${d.memory_total_mb} MB (${d.memory_percent}%)`;
    document.getElementById("statMemBar").style.width = d.memory_percent + "%";
    document.getElementById("statCpu").textContent = d.cpu_model;
  } catch (e) {
